...
tax_report1721_vii_page_response = TaxReport1721VIIPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
tax_report1721_vii_page_response = TaxReport1721VIIPageResponse.from_json(json_str)

# Convert to JSON
print(tax_report1721_vii_page_response.to_json())
```
...
data_dict = tax_report1721_vii_page_response.to_dict()
tax_report1721_vii_page_response = TaxReport1721VIIPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(tax_report1721_vii_page_response.total_pages)
# Update properties
tax_report1721_vii_page_response.total_pages = new_value
```
