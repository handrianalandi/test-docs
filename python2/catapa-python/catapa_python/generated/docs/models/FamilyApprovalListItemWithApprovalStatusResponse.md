...
family_approval_list_item_with_approval_status_response = FamilyApprovalListItemWithApprovalStatusResponse(
    id="''",
    name="''",
    gender="''",
    date_of_birth="''",
...
# Parse from JSON
json_str = '{"id": "example"}'
family_approval_list_item_with_approval_status_response = (
    FamilyApprovalListItemWithApprovalStatusResponse.from_json(json_str)
)

# Convert to JSON
print(family_approval_list_item_with_approval_status_response.to_json())
```
...
data_dict = family_approval_list_item_with_approval_status_response.to_dict()
family_approval_list_item_with_approval_status_response = (
    FamilyApprovalListItemWithApprovalStatusResponse.from_dict(data_dict)
)
```
...
```python
# Access properties
print(family_approval_list_item_with_approval_status_response.id)
# Update properties
family_approval_list_item_with_approval_status_response.id = "new_value"
```
