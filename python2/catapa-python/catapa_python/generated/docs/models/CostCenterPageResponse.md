...
cost_center_page_response = CostCenterPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
cost_center_page_response = CostCenterPageResponse.from_json(json_str)

# Convert to JSON
print(cost_center_page_response.to_json())
```
...
data_dict = cost_center_page_response.to_dict()
cost_center_page_response = CostCenterPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(cost_center_page_response.total_pages)
# Update properties
cost_center_page_response.total_pages = new_value
```
