...
location_group_page_response = LocationGroupPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
location_group_page_response = LocationGroupPageResponse.from_json(json_str)

# Convert to JSON
print(location_group_page_response.to_json())
```
...
data_dict = location_group_page_response.to_dict()
location_group_page_response = LocationGroupPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(location_group_page_response.total_pages)
# Update properties
location_group_page_response.total_pages = new_value
```
