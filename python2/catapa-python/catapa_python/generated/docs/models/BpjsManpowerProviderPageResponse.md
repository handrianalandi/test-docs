...
bpjs_manpower_provider_page_response = BpjsManpowerProviderPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
bpjs_manpower_provider_page_response = BpjsManpowerProviderPageResponse.from_json(
    json_str
)

# Convert to JSON
print(bpjs_manpower_provider_page_response.to_json())
```
...
data_dict = bpjs_manpower_provider_page_response.to_dict()
bpjs_manpower_provider_page_response = BpjsManpowerProviderPageResponse.from_dict(
    data_dict
)
```
...
```python
# Access properties
print(bpjs_manpower_provider_page_response.total_pages)
# Update properties
bpjs_manpower_provider_page_response.total_pages = new_value
```
