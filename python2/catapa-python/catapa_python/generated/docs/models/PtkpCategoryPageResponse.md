...
ptkp_category_page_response = PtkpCategoryPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
ptkp_category_page_response = PtkpCategoryPageResponse.from_json(json_str)

# Convert to JSON
print(ptkp_category_page_response.to_json())
```
...
data_dict = ptkp_category_page_response.to_dict()
ptkp_category_page_response = PtkpCategoryPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(ptkp_category_page_response.total_pages)
# Update properties
ptkp_category_page_response.total_pages = new_value
```
