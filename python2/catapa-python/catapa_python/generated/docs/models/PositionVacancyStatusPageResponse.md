...
position_vacancy_status_page_response = PositionVacancyStatusPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
position_vacancy_status_page_response = PositionVacancyStatusPageResponse.from_json(
    json_str
)

# Convert to JSON
print(position_vacancy_status_page_response.to_json())
```
...
data_dict = position_vacancy_status_page_response.to_dict()
position_vacancy_status_page_response = PositionVacancyStatusPageResponse.from_dict(
    data_dict
)
```
...
```python
# Access properties
print(position_vacancy_status_page_response.total_pages)
# Update properties
position_vacancy_status_page_response.total_pages = new_value
```
