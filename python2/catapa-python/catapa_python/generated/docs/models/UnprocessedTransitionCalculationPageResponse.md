...
unprocessed_transition_calculation_page_response = UnprocessedTransitionCalculationPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
unprocessed_transition_calculation_page_response = (
    UnprocessedTransitionCalculationPageResponse.from_json(json_str)
)

# Convert to JSON
print(unprocessed_transition_calculation_page_response.to_json())
```
...
data_dict = unprocessed_transition_calculation_page_response.to_dict()
unprocessed_transition_calculation_page_response = (
    UnprocessedTransitionCalculationPageResponse.from_dict(data_dict)
)
```
...
```python
# Access properties
print(unprocessed_transition_calculation_page_response.total_pages)
# Update properties
unprocessed_transition_calculation_page_response.total_pages = new_value
```
