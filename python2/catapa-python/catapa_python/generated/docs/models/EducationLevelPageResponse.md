...
education_level_page_response = EducationLevelPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
education_level_page_response = EducationLevelPageResponse.from_json(json_str)

# Convert to JSON
print(education_level_page_response.to_json())
```
...
data_dict = education_level_page_response.to_dict()
education_level_page_response = EducationLevelPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(education_level_page_response.total_pages)
# Update properties
education_level_page_response.total_pages = new_value
```
