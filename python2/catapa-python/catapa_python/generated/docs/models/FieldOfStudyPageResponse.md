...
field_of_study_page_response = FieldOfStudyPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
field_of_study_page_response = FieldOfStudyPageResponse.from_json(json_str)

# Convert to JSON
print(field_of_study_page_response.to_json())
```
...
data_dict = field_of_study_page_response.to_dict()
field_of_study_page_response = FieldOfStudyPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(field_of_study_page_response.total_pages)
# Update properties
field_of_study_page_response.total_pages = new_value
```
