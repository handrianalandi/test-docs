...
tax_calculation_page_response = TaxCalculationPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
tax_calculation_page_response = TaxCalculationPageResponse.from_json(json_str)

# Convert to JSON
print(tax_calculation_page_response.to_json())
```
...
data_dict = tax_calculation_page_response.to_dict()
tax_calculation_page_response = TaxCalculationPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(tax_calculation_page_response.total_pages)
# Update properties
tax_calculation_page_response.total_pages = new_value
```
