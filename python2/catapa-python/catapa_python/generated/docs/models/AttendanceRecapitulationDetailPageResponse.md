...
attendance_recapitulation_detail_page_response = AttendanceRecapitulationDetailPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
attendance_recapitulation_detail_page_response = (
    AttendanceRecapitulationDetailPageResponse.from_json(json_str)
)

# Convert to JSON
print(attendance_recapitulation_detail_page_response.to_json())
```
...
data_dict = attendance_recapitulation_detail_page_response.to_dict()
attendance_recapitulation_detail_page_response = (
    AttendanceRecapitulationDetailPageResponse.from_dict(data_dict)
)
```
...
```python
# Access properties
print(attendance_recapitulation_detail_page_response.total_pages)
# Update properties
attendance_recapitulation_detail_page_response.total_pages = new_value
```
