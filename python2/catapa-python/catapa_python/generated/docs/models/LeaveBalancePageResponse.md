...
leave_balance_page_response = LeaveBalancePageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
leave_balance_page_response = LeaveBalancePageResponse.from_json(json_str)

# Convert to JSON
print(leave_balance_page_response.to_json())
```
...
data_dict = leave_balance_page_response.to_dict()
leave_balance_page_response = LeaveBalancePageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(leave_balance_page_response.total_pages)
# Update properties
leave_balance_page_response.total_pages = new_value
```
