...
salary_payment_summary_page_response = SalaryPaymentSummaryPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
salary_payment_summary_page_response = SalaryPaymentSummaryPageResponse.from_json(
    json_str
)

# Convert to JSON
print(salary_payment_summary_page_response.to_json())
```
...
data_dict = salary_payment_summary_page_response.to_dict()
salary_payment_summary_page_response = SalaryPaymentSummaryPageResponse.from_dict(
    data_dict
)
```
...
```python
# Access properties
print(salary_payment_summary_page_response.total_pages)
# Update properties
salary_payment_summary_page_response.total_pages = new_value
```
