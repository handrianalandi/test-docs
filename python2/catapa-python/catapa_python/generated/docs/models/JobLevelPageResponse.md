...
| `content`            | [`List[JobLevelResponse]`](JobLevelResponse.md) |                                                |
...
job_level_page_response = JobLevelPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
job_level_page_response = JobLevelPageResponse.from_json(json_str)

# Convert to JSON
print(job_level_page_response.to_json())
```
...
data_dict = job_level_page_response.to_dict()
job_level_page_response = JobLevelPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(job_level_page_response.total_pages)
# Update properties
job_level_page_response.total_pages = new_value
```
