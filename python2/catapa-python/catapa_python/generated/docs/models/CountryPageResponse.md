...
country_page_response = CountryPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
country_page_response = CountryPageResponse.from_json(json_str)

# Convert to JSON
print(country_page_response.to_json())
```
...
data_dict = country_page_response.to_dict()
country_page_response = CountryPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(country_page_response.total_pages)
# Update properties
country_page_response.total_pages = new_value
```
