...
bpjs_healthcare_template_page_response = BpjsHealthcareTemplatePageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
bpjs_healthcare_template_page_response = BpjsHealthcareTemplatePageResponse.from_json(
    json_str
)

# Convert to JSON
print(bpjs_healthcare_template_page_response.to_json())
```
...
data_dict = bpjs_healthcare_template_page_response.to_dict()
bpjs_healthcare_template_page_response = BpjsHealthcareTemplatePageResponse.from_dict(
    data_dict
)
```
...
```python
# Access properties
print(bpjs_healthcare_template_page_response.total_pages)
# Update properties
bpjs_healthcare_template_page_response.total_pages = new_value
```
