...
shift_pattern_template_page_response = ShiftPatternTemplatePageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
shift_pattern_template_page_response = ShiftPatternTemplatePageResponse.from_json(
    json_str
)

# Convert to JSON
print(shift_pattern_template_page_response.to_json())
```
...
data_dict = shift_pattern_template_page_response.to_dict()
shift_pattern_template_page_response = ShiftPatternTemplatePageResponse.from_dict(
    data_dict
)
```
...
```python
# Access properties
print(shift_pattern_template_page_response.total_pages)
# Update properties
shift_pattern_template_page_response.total_pages = new_value
```
