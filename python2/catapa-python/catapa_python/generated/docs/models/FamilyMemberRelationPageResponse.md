...
family_member_relation_page_response = FamilyMemberRelationPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
family_member_relation_page_response = FamilyMemberRelationPageResponse.from_json(
    json_str
)

# Convert to JSON
print(family_member_relation_page_response.to_json())
```
...
data_dict = family_member_relation_page_response.to_dict()
family_member_relation_page_response = FamilyMemberRelationPageResponse.from_dict(
    data_dict
)
```
...
```python
# Access properties
print(family_member_relation_page_response.total_pages)
# Update properties
family_member_relation_page_response.total_pages = new_value
```
