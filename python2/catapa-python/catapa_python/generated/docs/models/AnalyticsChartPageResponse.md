...
analytics_chart_page_response = AnalyticsChartPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
analytics_chart_page_response = AnalyticsChartPageResponse.from_json(json_str)

# Convert to JSON
print(analytics_chart_page_response.to_json())
```
...
data_dict = analytics_chart_page_response.to_dict()
analytics_chart_page_response = AnalyticsChartPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(analytics_chart_page_response.total_pages)
# Update properties
analytics_chart_page_response.total_pages = new_value
```
