...
employee_variable_page_response = EmployeeVariablePageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
employee_variable_page_response = EmployeeVariablePageResponse.from_json(json_str)

# Convert to JSON
print(employee_variable_page_response.to_json())
```
...
data_dict = employee_variable_page_response.to_dict()
employee_variable_page_response = EmployeeVariablePageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(employee_variable_page_response.total_pages)
# Update properties
employee_variable_page_response.total_pages = new_value
```
