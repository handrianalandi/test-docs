...
paygroup_page_response = PaygroupPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
paygroup_page_response = PaygroupPageResponse.from_json(json_str)

# Convert to JSON
print(paygroup_page_response.to_json())
```
...
data_dict = paygroup_page_response.to_dict()
paygroup_page_response = PaygroupPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(paygroup_page_response.total_pages)
# Update properties
paygroup_page_response.total_pages = new_value
```
