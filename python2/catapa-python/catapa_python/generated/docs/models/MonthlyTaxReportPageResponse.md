...
monthly_tax_report_page_response = MonthlyTaxReportPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
monthly_tax_report_page_response = MonthlyTaxReportPageResponse.from_json(json_str)

# Convert to JSON
print(monthly_tax_report_page_response.to_json())
```
...
data_dict = monthly_tax_report_page_response.to_dict()
monthly_tax_report_page_response = MonthlyTaxReportPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(monthly_tax_report_page_response.total_pages)
# Update properties
monthly_tax_report_page_response.total_pages = new_value
```
