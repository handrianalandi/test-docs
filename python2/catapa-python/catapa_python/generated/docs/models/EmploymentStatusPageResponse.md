...
employment_status_page_response = EmploymentStatusPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
employment_status_page_response = EmploymentStatusPageResponse.from_json(json_str)

# Convert to JSON
print(employment_status_page_response.to_json())
```
...
data_dict = employment_status_page_response.to_dict()
employment_status_page_response = EmploymentStatusPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(employment_status_page_response.total_pages)
# Update properties
employment_status_page_response.total_pages = new_value
```
