...
location_page_response = LocationPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
location_page_response = LocationPageResponse.from_json(json_str)

# Convert to JSON
print(location_page_response.to_json())
```
...
data_dict = location_page_response.to_dict()
location_page_response = LocationPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(location_page_response.total_pages)
# Update properties
location_page_response.total_pages = new_value
```
