...
institution_page_response = InstitutionPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
institution_page_response = InstitutionPageResponse.from_json(json_str)

# Convert to JSON
print(institution_page_response.to_json())
```
...
data_dict = institution_page_response.to_dict()
institution_page_response = InstitutionPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(institution_page_response.total_pages)
# Update properties
institution_page_response.total_pages = new_value
```
