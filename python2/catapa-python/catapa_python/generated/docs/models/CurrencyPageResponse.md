...
currency_page_response = CurrencyPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
currency_page_response = CurrencyPageResponse.from_json(json_str)

# Convert to JSON
print(currency_page_response.to_json())
```
...
data_dict = currency_page_response.to_dict()
currency_page_response = CurrencyPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(currency_page_response.total_pages)
# Update properties
currency_page_response.total_pages = new_value
```
