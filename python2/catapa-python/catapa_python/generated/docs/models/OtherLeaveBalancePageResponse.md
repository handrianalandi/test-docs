...
other_leave_balance_page_response = OtherLeaveBalancePageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
other_leave_balance_page_response = OtherLeaveBalancePageResponse.from_json(json_str)

# Convert to JSON
print(other_leave_balance_page_response.to_json())
```
...
data_dict = other_leave_balance_page_response.to_dict()
other_leave_balance_page_response = OtherLeaveBalancePageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(other_leave_balance_page_response.total_pages)
# Update properties
other_leave_balance_page_response.total_pages = new_value
```
