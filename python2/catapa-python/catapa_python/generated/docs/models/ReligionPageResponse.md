...
religion_page_response = ReligionPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
religion_page_response = ReligionPageResponse.from_json(json_str)

# Convert to JSON
print(religion_page_response.to_json())
```
...
data_dict = religion_page_response.to_dict()
religion_page_response = ReligionPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(religion_page_response.total_pages)
# Update properties
religion_page_response.total_pages = new_value
```
