...
organization_head_page_response = OrganizationHeadPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
organization_head_page_response = OrganizationHeadPageResponse.from_json(json_str)

# Convert to JSON
print(organization_head_page_response.to_json())
```
...
data_dict = organization_head_page_response.to_dict()
organization_head_page_response = OrganizationHeadPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(organization_head_page_response.total_pages)
# Update properties
organization_head_page_response.total_pages = new_value
```
