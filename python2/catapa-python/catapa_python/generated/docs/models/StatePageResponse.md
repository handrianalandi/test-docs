...
state_page_response = StatePageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
state_page_response = StatePageResponse.from_json(json_str)

# Convert to JSON
print(state_page_response.to_json())
```
...
data_dict = state_page_response.to_dict()
state_page_response = StatePageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(state_page_response.total_pages)
# Update properties
state_page_response.total_pages = new_value
```
