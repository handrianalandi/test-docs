...
employee_detail_page_response = EmployeeDetailPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
employee_detail_page_response = EmployeeDetailPageResponse.from_json(json_str)

# Convert to JSON
print(employee_detail_page_response.to_json())
```
...
data_dict = employee_detail_page_response.to_dict()
employee_detail_page_response = EmployeeDetailPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(employee_detail_page_response.total_pages)
# Update properties
employee_detail_page_response.total_pages = new_value
```
