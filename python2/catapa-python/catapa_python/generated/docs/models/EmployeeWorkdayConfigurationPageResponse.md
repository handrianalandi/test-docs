...
employee_workday_configuration_page_response = EmployeeWorkdayConfigurationPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
employee_workday_configuration_page_response = (
    EmployeeWorkdayConfigurationPageResponse.from_json(json_str)
)

# Convert to JSON
print(employee_workday_configuration_page_response.to_json())
```
...
data_dict = employee_workday_configuration_page_response.to_dict()
employee_workday_configuration_page_response = (
    EmployeeWorkdayConfigurationPageResponse.from_dict(data_dict)
)
```
...
```python
# Access properties
print(employee_workday_configuration_page_response.total_pages)
# Update properties
employee_workday_configuration_page_response.total_pages = new_value
```
