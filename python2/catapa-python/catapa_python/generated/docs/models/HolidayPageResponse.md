...
holiday_page_response = HolidayPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
holiday_page_response = HolidayPageResponse.from_json(json_str)

# Convert to JSON
print(holiday_page_response.to_json())
```
...
data_dict = holiday_page_response.to_dict()
holiday_page_response = HolidayPageResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(holiday_page_response.total_pages)
# Update properties
holiday_page_response.total_pages = new_value
```
