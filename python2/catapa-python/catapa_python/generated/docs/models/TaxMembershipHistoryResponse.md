...
tax_membership_history_response = TaxMembershipHistoryResponse(
    id="''",
...
# Parse from JSON
json_str = '{"id": "example"}'
tax_membership_history_response = TaxMembershipHistoryResponse.from_json(json_str)

# Convert to JSON
print(tax_membership_history_response.to_json())
```
...
data_dict = tax_membership_history_response.to_dict()
tax_membership_history_response = TaxMembershipHistoryResponse.from_dict(data_dict)
```
...
```python
# Access properties
print(tax_membership_history_response.id)
# Update properties
tax_membership_history_response.id = "new_value"
```
