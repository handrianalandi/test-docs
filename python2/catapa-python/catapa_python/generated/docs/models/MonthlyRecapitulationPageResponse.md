...
monthly_recapitulation_page_response = MonthlyRecapitulationPageResponse(
    total_pages=56,
    last=True,
    total_elements=56,
...
monthly_recapitulation_page_response = MonthlyRecapitulationPageResponse.from_json(
    json_str
)

# Convert to JSON
print(monthly_recapitulation_page_response.to_json())
```
...
data_dict = monthly_recapitulation_page_response.to_dict()
monthly_recapitulation_page_response = MonthlyRecapitulationPageResponse.from_dict(
    data_dict
)
```
...
```python
# Access properties
print(monthly_recapitulation_page_response.total_pages)
# Update properties
monthly_recapitulation_page_response.total_pages = new_value
```
