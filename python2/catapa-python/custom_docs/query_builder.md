...
SearchQueryBuilder().filter("startDate", {"from": "2024-01-01", "to": "2024-12-31"}).build_query()
...
SearchQueryBuilder().filter("isActive", True).filter("organizationId", "123").build_query()
